...
**Contribution surface.** This file and `SECURITY.md` exist. The repository is public today by an explicit owner decision of 2026-08-27 — the visibility history and the still-open public-release gate are tracked in [`docs/project-context.md`](docs/project-context.md) — and being public is not a release. No external triage process is in place, and none is created until distribution is unblocked.
